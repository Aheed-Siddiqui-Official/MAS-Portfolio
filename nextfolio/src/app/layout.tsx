...
const APP_KEYWORDS = ["Muhammad Aheed Siddiqui", "Muhammad Aheed Siddiqui Portfolio", "Aheed Siddiqui Portfolio", "Portfolio", "Web Developer", "MERN Stack Developer", "React", "JavaScript", "Frontend", "Backend", "Projects", "Software Engineer"];
